...
let urlTemplates: IDictionary<[RegExp, (html: any, url: string) => any]> = {
    ...
    main: [/\/\w+\/main\/unit\/view\/\d+\/?$/gi, parseUnitMain],
    ...
    salecontract: [/zzz/gi, parseX],
    prodsupply: [/zzz/gi, parseX],
    consume: [/zzz/gi, parseX],
    storesupply: [/\/\w+\/main\/unit\/view\/\d+\/supply\/?$/gi, parseStoreSupply],
    tradehall: [/\/\w+\/main\/unit\/view\/\d+\/trading_hall\/?$/gi, parseTradeHall],
    service: [/zzz/gi, parseX],
    servicepricehistory: [/zzz/gi, parseX],
    retailreport: [/zzz/gi, parseX],
    pricehistory: [/zzz/gi, parseX],
    TM: [/zzz/gi, parseX],
    IP: [/zzz/gi, parseX],
    transport: [/zzz/gi, parseX],
    CTIE: [/zzz/gi, parseX],
    training: [/zzz/gi, parseX],
    equipment: [/zzz/gi, parseX],
    tech: [/zzz/gi, parseX],
    products: [/zzz/gi, parseX],
    waresupply: [/zzz/gi, parseX],
    contract: [/zzz/gi, parseX],
    research: [/zzz/gi, parseX],
    experimentalunit: [/zzz/gi, parseX],
    financeitem: [/zzz/gi, parseX],
    machines: [/zzz/gi, parseX],
    animals: [/zzz/gi, parseX],
    size: [/\/\w+\/window\/unit\/upgrade\/\d+\/?$/ig, parseWareSize],
